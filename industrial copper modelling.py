...
phn = Image.open("R:\copper.jpg")
st.set_page_config(page_title="Industrial Copper Modeling Application", page_icon=phn, layout="wide", )
...
with tab1:
    ...
    with st.form("my_form"):
        ...
        with col3:
            st.write(
                f'<h5 style="color:#990000;">NOTE: Min & Max given for reference, you can enter any value</h5>',
    ...
    if submit_button and flag == 0:
        ...
        with open("R:/pickle/model.pkl", 'rb') as file:
            loaded_model = pickle.load(file)
        with open("R:/pickle/scaler.pkl", 'rb') as f:
            scaler_loaded = pickle.load(f)

        with open("R:/pickle/t.pkl", 'rb') as f:
            t_loaded = pickle.load(f)

        with open("R:/pickle/s.pkl", 'rb') as f:
...
with tab2:
    ...
    if csubmit_button and cflag == 0:
        ...
        with open("R:/pickle/cmodel2.pkl", 'rb') as file:
            cloaded_model = pickle.load(file)

        with open("R:/pickle/cscaler2.pkl", 'rb') as f:
            cscaler_loaded = pickle.load(f)

        with open("R:/pickle/ct2.pkl", 'rb') as f:
